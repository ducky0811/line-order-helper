const state = { token: localStorage.getItem('adminToken'), products: [], orders: [], report: null, fulfillmentOptions: [], orderView: 'active', orderStatus: 'all', orderQuery: '', orderDraftDirty: false, reportRange: 'month', activeTab: 'products', account: null, lineIntegration: null, sheetIntegration: null, lineStep: 1 };
